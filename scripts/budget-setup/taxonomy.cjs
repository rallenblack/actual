...
const taxonomy = [
  ...
  },
  {
    ...
    categories: [
      ...
      { name: 'Subscriptions & Streaming', match: ['NETFLIX', 'HULU', 'DISNEY', 'SPOTIFY', 'YOUTUBE', 'HBO', 'PARAMOUNT+', 'PEACOCK', 'APPLE.COM/BILL', 'AMAZON PRIME', 'PRIME VIDEO', 'AUDIBLE', 'ADOBE', 'DROPBOX', 'CHATGPT', 'OPENAI', 'ANTHROPIC', 'CLAUDE.AI', 'MICROSOFT', 'PADDLE', 'SALT LAKE TRIBUNE', 'SLTRIB', 'SIMPLEFIN', 'APPLE', 'KINDLE', 'SCRIBD', 'NEW YORK TIMES', 'GRAMMARLY', 'IFTTT'] },
    ],
  },
  {
    group: 'Everyday',
    categories: [
      ...
      { name: 'Restaurants & Dining', match: ['MCDONALD', 'CHICK-FIL-A', 'CHICKFILA', 'TACO BELL', 'DEL TACO', "WENDY'S", 'BURGER KING', 'CHIPOTLE', 'PANDA EXPRESS', 'SUBWAY', 'CAFE RIO', 'COSTA VIDA', 'OLIVE GARDEN', 'TEXAS ROADHOUSE', 'IN-N-OUT', 'IN N OUT', 'CRUMBL', 'DOORDASH', 'UBER EATS', 'UBEREATS', 'GRUBHUB', 'DOMINO', 'PIZZA', 'LITTLE CAESAR', 'PAPA JOHN', 'CHILI', 'KNEADERS', 'GOLDEN CORRAL', 'LEVY RESTAURANTS', 'TSUBAME', 'ORIGINAL PANCAKE', 'PANCAKE HOUSE', "SALTY'S", 'SALTYS', 'HILL AIRFORCE', 'HILL AIR FORCE', 'PANERA', 'WINGSTOP', 'GANDOLFO', 'THE PIE PIZZERIA', 'CLIFF DINING', 'BOUDIN', 'BROOKERS', 'DOCO MARKET', 'AMARA LEHI', 'BRICK CANVAS CAFE'] },
      { name: 'Coffee & Treats', match: ['STARBUCKS', 'DUTCH BROS', 'SWIG', 'SODALICIOUS', 'BEANS & BREWS', 'FIIZ', '365 RETAIL', 'PINKBOX', 'GOURMANDISE', 'LEHI BAKERY', 'BLACK BOW'] },
      ...
      { name: 'Shopping & Household', match: ['AMAZON', 'AMZN', 'TARGET', 'HOME DEPOT', 'LOWES', "LOWE'S", 'IKEA', 'DOLLAR TREE', 'DOLLAR GENERAL', 'BED BATH', 'BEST BUY', 'SHUTTERFLY', 'FIVE BELOW', 'BOX LUNCH'] },
      { name: 'Personal Care', match: ['GREAT CLIPS', 'ULTA', 'SEPHORA', 'SALON', 'BARBER', 'MASSAGE', 'GOAT HAIRCUTS', 'HAIRCUT', 'BRICK CANVAS'] },
      { name: 'Health & Pharmacy', match: ['CVS', 'WALGREENS', 'RITE AID', 'INTERMOUNTAIN', 'REVERE HEALTH', 'MOUNTAINSTAR', 'DENTAL', 'PHARMACY', 'TRU LIVING', 'PSYCHOLOGY', 'THERAPY', 'PEDIATRIC', 'OBGYN', 'MED EXCEL', 'DENTIS'] },
      { name: 'Clothing', match: ['NIKE', 'OLD NAVY', 'KOHLS', "KOHL'S", 'ROSS STORE', 'TJ MAXX', 'TJMAXX', 'NORDSTROM', 'LULULEMON', 'DSW', 'FOOT LOCKER', 'H&M', 'MARSHALLS', "CHILDREN'S PLACE", 'KID TO KID'] },
  ...
  },
  {
    group: 'Lifestyle',
    categories: [
      { name: 'Entertainment', match: ['CINEMARK', 'MEGAPLEX', 'AMC ', 'STEAM', 'PLAYSTATION', 'XBOX', 'NINTENDO', 'TICKETMASTER', 'SEATGEEK', 'TOPGOLF', 'HUMBLE BUNDLE', 'RUMBLE ROYALE', 'WISEGUYS', 'COMEDYSPORTZ', 'WEST VALLEY ARTS', 'WVCARTS', 'MINECRAFT', 'RSL.COM', 'WIZARDS OF', 'WE GEEK'] },
      ...
      { name: 'Travel & Vacation', match: ['DELTA AIR', 'SOUTHWEST', 'UNITED AIR', 'AMERICAN AIR', 'FRONTIER', 'ALLEGIANT', 'MARRIOTT', 'HILTON', 'HYATT', 'AIRBNB', 'VRBO', 'EXPEDIA', 'BOOKING.COM', 'ENTERPRISE RENT', 'HERTZ', 'TURO', 'PRINCESS CRUISES', 'ROYAL PRINCESS'] },
      { name: 'Gifts' },
      { name: 'Donations & Giving' },
      { name: 'Kids & Childcare', match: ['BOBBY LAWRENCE', 'KARATE', 'UTAH SOCCER', 'SOCCER', 'PIANO PLACE', 'ONE MUSIC', 'UVENTEX', 'IMPACT NINJA', 'NINJA GYM', 'BUILD-A-BEAR'] },
      { name: 'Education', match: ['TUITION', 'UDEMY', 'COURSERA', 'CHEGG', 'ALPINE SCHOOL', 'SCHOOL DISTRICT'] },
    ],
  },
  {
    group: 'Financial',
    categories: [
      { name: 'Bank Fees', match: ['OVERDRAFT', 'SERVICE CHARGE', 'ATM FEE', 'NSF FEE', 'INTEREST CHARGE', 'ANNUAL FEE', 'LATE FEE', 'MEMBERSHIP FEE', 'MONTHLY SERVICE FEE'] },
      { name: 'Taxes', match: ['IRS ', 'TREAS TAX', 'UTAH STATE TAX', 'UTAH TAX', 'TAX PAYMENT', 'FRANCHISE TAX', 'H&R BLOCK'] },
